...
# Rationale: ENGAGEMENT_DIR / TARGETS_FILE are exported by the
# recon-suite orchestrator (run_external_recon_suite.sh) before any
# task script is invoked. ShellCheck cannot follow that load chain.
